...
impl Plugin for BigSpacePropagationPlugin {
    fn build(&self, app: &mut App) {
        let configs = || {
            (
                tag_low_precision_roots // loose ordering on this set
...
pub fn propagate_high_precision(
    ...
    entities
        ...
        .for_each(|(grid, mut global_transform)| {
            ...
            *global_transform = grid.global_transform(&CellCoord::default(), &Transform::IDENTITY);
        });
            ...
            .add_systems(Startup, |mut commands: Commands| {
                commands.spawn_big_space_default(|root| {
                    ...
                    root.spawn_spatial((
                        ...
                        CellCoord::new(1, 1, 1), // The default cell size is 2000
                    ))
